...
namespace TestSuite.Runtime.Tools
{
	...
	public class SettingsTest
	{
		...
		private void SetBaseSetting()
		{
			...
			baseSetting.UserBinaryLocation = "UserBin\\TestUserBinary.dll";
			baseSetting.UserBinaryName = "TestBinary";
			baseSetting.UserBinaryClassName = "TestUserBinary.TestBinary";
			baseSetting.UseUserBinaries = true;
