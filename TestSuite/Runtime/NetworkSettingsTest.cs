...
namespace TestSuite.Runtime
{
	...
	public class NetworkSettingsTest
	{
		...
		/// <summary>
		///A test for UseUserBinaries
		///</summary>
		[TestMethod()]
		public void UseUserBinariesTest()
		{
			NetworkSettings target = new NetworkSettings(); // TODO: Initialize to an appropriate value
			bool expected = false; // TODO: Initialize to an appropriate value
			bool actual;
			target.UseUserBinaries = expected;
			actual = target.UseUserBinaries;
			Assert.AreEqual(expected, actual);
			Assert.Inconclusive("Verify the correctness of this test method.");
		}

		/// <summary>
		///A test for UserBinaryClassName
		///</summary>
		[TestMethod()]
		public void UserBinaryClassNameTest()
		{
			NetworkSettings target = new NetworkSettings(); // TODO: Initialize to an appropriate value
			string expected = string.Empty; // TODO: Initialize to an appropriate value
			string actual;
			target.UserBinaryClassName = expected;
			actual = target.UserBinaryClassName;
			Assert.AreEqual(expected, actual);
			Assert.Inconclusive("Verify the correctness of this test method.");
		}

		/// <summary>
		///A test for UserBinaryLocation
		///</summary>
		[TestMethod()]
		public void UserBinaryLocationTest()
		{
			NetworkSettings target = new NetworkSettings(); // TODO: Initialize to an appropriate value
			string expected = string.Empty; // TODO: Initialize to an appropriate value
			string actual;
			target.UserBinaryLocation = expected;
			actual = target.UserBinaryLocation;
			Assert.AreEqual(expected, actual);
			Assert.Inconclusive("Verify the correctness of this test method.");
		}

		/// <summary>
		///A test for UserBinaryName
		///</summary>
		[TestMethod()]
		public void UserBinaryNameTest()
		{
			NetworkSettings target = new NetworkSettings(); // TODO: Initialize to an appropriate value
			string expected = string.Empty; // TODO: Initialize to an appropriate value
			string actual;
			target.UserBinaryName = expected;
			actual = target.UserBinaryName;
			Assert.AreEqual(expected, actual);
			Assert.Inconclusive("Verify the correctness of this test method.");
		}
	}
